...
//https://sistemas.dpc.mar.mil.br/sisap/agendamento/server/validargruinformada.php?nidom=100&nnumerodagru=060893200250412022&ncpfcnpj=070.698.228-20
...
export function getServices({
  ...
  identifier,
  nidom,
}: getServicesProps): ApiResponseProps<Services[]> {
  const response = JSON.parse(
    AVAILABLE_SERVICES.replace(/(\r)(\n)/gi, '')
